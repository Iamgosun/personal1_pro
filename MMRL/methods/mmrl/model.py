...
class MMRLMethod(BaseMethod):
    ...
    def build(self):
        from trainers import mmrl as legacy

        cfg = self.cfg
        classnames = self.dm.dataset.classnames
        clip_model = legacy.load_clip_to_cpu(cfg, 'MMRL')
        ...
        self.loss = MMRLLossAdapter(legacy.MMRL_Loss(reg_weight=cfg.MMRL.REG_WEIGHT, alpha=cfg.MMRL.ALPHA))
        return self
