...
DATASETS=${DATASETS:-"caltech101 dtd eurosat fgvc_aircraft food101 imagenet oxford_flowers oxford_pets sun397 stanford_cars ucf101"}
...
BAYES_REP_PRIOR_STD_LIST=${BAYES_REP_PRIOR_STD_LIST:-"0.1 0.5 1.0"}
BAYES_REP_KL_WEIGHT_LIST=${BAYES_REP_KL_WEIGHT_LIST:-"1e-3 1e-2 5e-2"}
